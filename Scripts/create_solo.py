...
Usage:
    ...
    python3 Scripts/create_solo.py --start 2020 --end 2025

    # With optional distance filtering:
    python3 Scripts/create_solo.py --start 2022 --end 2025 --min-distance 0.5

    # Convert propagated data to MSWIM2D lookup table format:
    python3 Scripts/create_solo.py --write-lookup-table --start 2022 --end 2025
"""
import os
import sys
import gzip
